# Intex Project - Professor Insights & Advice

## General Philosophy

- This is your culminating junior year experience — everything from both semesters comes together here.
- The goal is to apply your skills to something meaningful: protecting girls in the Philippines through a real-world inspired system.
- Don't stress over individual points. InTex almost never changes anyone's final grade up or down significantly.
- Work hard, have fun, take care of yourself. Go outside at least once.

---

## How to Use AI Effectively (Professor Keith)

Use AI in this order — **reverse of what most people do:**

1. **Problem Setter** – Tell AI the problem you're trying to solve. Ask: *"Am I asking the right questions? Do I have the right assumptions?"*
2. **Creative Expander** – Share your own ideas first, then ask: *"What haven't I thought of? Should I think bigger?"* (If you skip your own ideas, your output will look like everyone else's.)
3. **Critical Evaluator** – Ask: *"Tell me every reason this is a bad idea and where it might go wrong."*
4. **Verification Agent** – Ask: *"Are my expectations correct? Give me reasons to support moving forward."*
5. **Production Agent** – Only now do you say: *"Let's build."*

> Most people start at step 5 and never go back. Don't be that team.

---

## Machine Learning Pipelines (Professor Keith)

- Requirements are **intentionally vague** — creativity is the point.
- There are 12+ ML pipeline opportunities in the data. You don't have to do all of them.
- **Quality > Quantity.** A few dynamic, well-built pipelines beat many shallow ones.
- "Quality" does NOT mean throwing every algorithm at a problem. It means:
  - Making pipelines **dynamic** (works as new data comes in, not hardcoded)
  - Using proper feature selection, automated algorithm selection, hyperparameter tuning
  - Following the CRISP-DM principles covered in class
- **Accuracy scores don't matter.** R-squared, p-values — none of that affects your grade. You can't force the data to tell a story. Cast a wide net and let the data lie where it may.
- Social media is a specific pain point Julie mentioned — she needs help managing it to attract donors. There's synthetic social media data (posts, reach, likes, clicks) to work with.
- Put all Jupyter notebooks and `.py` files in a folder called `ML Pipelines` in your project repo.
- Don't under-effort OR over-effort this section relative to the others. Know yourself.

---

## Web Development (Professor Hilton)

- Stack: **.NET backend + React TypeScript (Vite) frontend**
- Database options: PostgreSQL, MySQL, or Azure SQL
- The website is the **face of your project** — judges will see it, you'll present from it.
- What's on the website is driven by requirements from all the other classes.
- Every requirement is a small slice of 20 points — don't spend 8 hours on something worth 1%.
- **Deployment is flexible** — Vercel, AWS, Azure, whatever you know. Just make it publicly accessible.
- Deployment costs should be **$0–$30 per group**. Do NOT max out CPU/memory/regions.
- Keep services running until grading is confirmed (likely Monday night after submission).
- Little finishing touches and smooth UX are what separate top teams from the rest.

---

## Security (Professor Wells)

- Security won't impress judges in your presentation — just mention it briefly (e.g., *"We added security to protect the anonymity of the girls"*).
- Required items:
  - HTTPS (usually automatic with cloud providers)
  - Authentication & authorization with **multiple roles**
  - Correct password configuration (follow the video, not Microsoft defaults)
  - Role-based access control
  - Delete confirmations (don't let data vanish without an "Are you sure?" prompt)
  - Privacy policy (use the provided website — should take ~10 minutes)
  - CSP header (it will break your site first — loosen it until it works)
- **4 out of 20 points** in this class come from deployment.
- There are **2 "do something extra" points** — third-party auth, or other additions.

---

## Scrum / Project Management (Professor Cutler)

- Four 1-day sprints, each ending at **11:59pm**.
- All deliverables live in one **FigJam board** you fill out progressively all week.
- To duplicate the FigJam template: click the title → down arrow → sign in → duplicate → share publicly.
- Grading is 50/50: half for completing the artifact, half for quality of content.
- Points are split: 20 points from this FigJam doc + 20 points from overall InTex score.

### Daily Deliverables:
| Day | Deliverables |
|-----|-------------|
| Monday | Scrum Master + Product Owner assigned, Personas, User Journey, MoSCoW table, Product Backlog, Wireframes (3 key frames) |
| Tuesday | 3 AI-generated UI options + decision, Tech stack diagram |
| Wednesday | Desktop + mobile screenshots, 1 page deployed, real user feedback + changes made, burn-down chart |
| Thursday | OKR metric live on site, 90% accessibility score, responsiveness check, retrospective |

---

## Presentation (All Professors)

- Worth **20 points** — treat it like a full class deliverable.
- You are presenting to a fictional organization like Lighthouse (you name it) that wants to expand globally.
- Julie will be in one of the rooms. So will faculty, alumni, industry judges, and the advisory board.
- **Do NOT spend half your presentation explaining what Lighthouse does.** Give 1–2 slides of context, then show what you built and how it meets their needs.
- Tell a story. Make it exciting. Show the cool features.
- Practice it. Get sleep before it. Make it flow smoothly.
- The team that wins the room usually has **one genuinely cool, useful feature** that lands well with the judges.
- Judges are normalized across rooms — if you're in a tough room, that's accounted for.
...
| Component | Points |
|-----------|--------|
| IS 401 (Cutler) | 20 pts |
| IS 455 (Hilton) | 20 pts |
| IS 414 (Wells) | 20 pts |
| IS 425 (Keith) | 20 pts |
| Presentation | 20 pts |
| **Total** | **100 pts** |

> Peer evaluation adjustments apply on top of this. Be a good teammate.
