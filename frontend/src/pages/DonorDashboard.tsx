      ...
      <header className="border-b border-border bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 md:px-10">
          ...
          <div className="flex items-center gap-5">
            <span className="hidden text-sm text-medium-gray sm:inline">{authSession.email}</span>
            <Link to="/logout" className="text-sm font-medium text-medium-gray hover:text-black transition-colors">Log out</Link>
          </div>
        </div>
      </header>
