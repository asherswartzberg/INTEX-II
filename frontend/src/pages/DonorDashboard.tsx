      ...
      <header role="banner" className="border-b border-border bg-white px-4 py-3 md:px-6 md:py-4 dark:bg-[#1a1a1a] dark:border-[#333]">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            <Link to="/" aria-label="Home" className="flex items-center gap-1.5 text-sm font-medium text-medium-gray hover:text-black transition-colors">
            ...
            <Link to="/logout" aria-label="Log out" className="flex items-center gap-1.5 text-sm font-medium text-medium-gray hover:text-black transition-colors">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
